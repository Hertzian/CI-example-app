...
class Auth extends ShieldAuth
{
    ...
    public array $actions = [
        // 'register' => \CodeIgniter\Shield\Authentication\Actions\EmailActivator::class, // this is for activate, 'Activation code' email
        'register' => null,
        'login'    => null,
    ];
     ...
     */
    public string $userProvider = \App\Models\UserModel::class; // this is needed when you add more fields to the users table
