...
use finfo; // file info class, to fix the image visualization
...
class Image extends BaseController
{
    ...
    public function create($id)
    {
        ...
        $path = $file->store('article_images'); // 'Writable/uploads/article_images' folder
        ...
        $this->model
            ->protect(false) // to prevent save fields that aren't allowed in the model
            ->save($article);
    ...
    public function get($id)
    {
        ...
        if ($article->image) {
            ...
            readfile($path); // php native method
